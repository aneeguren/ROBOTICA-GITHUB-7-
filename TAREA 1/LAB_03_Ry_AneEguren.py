...
def rotateY(t):
    ...
    while n < t: 
        ...
        # draw vector1
        v1 = np.array([0,0,1]) #DIBUJA EL VECTOR
        drawVector(v1)

        # draw vector2
        v2 = RotY(n).dot(v1) #ROTO EL VECTOR N GRADOS
...
rotateY(45) #AQUI ESTAS PONIENDO CUANTO ES t, SE VA A MOVER HASTA LOS GRADOS Q PONGAS AQUI, EN ESTE CASO SON 45ºTU
